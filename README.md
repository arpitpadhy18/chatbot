...
A modern, full-stack web application that allows users to upload documents (PDF, Excel, Images, XML) and chat with them using an AI-powered RAG (Retrieval-Augmented Generation) system.
